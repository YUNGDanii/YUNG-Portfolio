const order = [
  ...
  "8447","8476","8474","8449","8463","8460","84const order = [
  "8455","8467","8442","8456","8470","8444","8458","8461",
...
/*
  KÜNSTLICHE FULLWIDTH-POSITIONEN
  --------------------------------
  Diese Bilder werden über beide Spalten gezogen.

  Die Positionen sind 0-basiert:
  erstes Bild = 0
*/
const fullWidthPositions = new Set([
  2,
  5,
  7,
  16,
...
order.forEach((id, index) => {
  ...
  if (fullWidthPositions.has(index)) {
    figure.classList.add("full");
  }
